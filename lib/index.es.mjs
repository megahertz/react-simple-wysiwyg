...
var css = ".rsw-editor{display:flex;flex-direction:column;min-height:100px;overflow:hidden}.rsw-ce{border:1px solid #eeeff3;border-radius:6px;flex:1 0 auto;min-height:164px;outline:none;padding-left:12px;padding-right:8px;padding-top:65px;position:relative}.rsw-ce[contentEditable=true]:empty:not(:focus):before{color:grey;content:attr(placeholder)}.rsw-html{background:transparent;border:none;font-family:Inter,sans-serif}.rsw-ce:focus{border:2px solid #7c91fa}.rsw-separator{background:#eeeff3;height:24px;margin-left:6px;margin-right:6px;width:1px}.rsw-dd{box-sizing:border-box;outline:none}.rsw-btn{align-items:center;background:transparent;border:0;border-radius:6px;cursor:pointer;display:flex;font-size:1em;height:24px;justify-content:center;outline:none;padding:0;width:24px}.rsw-btn:hover,.rsw-btn[data-active=true]{background:#e6eafe}.rsw-toolbar{align-items:center;background-color:#fafbfc;border:1px solid #f4f5f8;border-radius:6px;display:flex;height:32px;padding-left:4px;position:absolute;right:25px;top:25px;width:97%}";
n(css,{});
...
export { BtnAligenLeft, BtnAlignCenter, BtnAlignRight, BtnBold, BtnBulletList, BtnClearFormatting, BtnItalic, BtnLink, BtnNumberedList, BtnRedo, BtnStrikeThrough, BtnStyles, BtnUnderline, BtnUndo, ContentEditable, DefaultEditor, Dropdown, Editor, EditorContext, EditorProvider, HtmlButton, HtmlEditor, Separator, Toolbar, createButton, createDropdown, DefaultEditor as default, useEditorState };
